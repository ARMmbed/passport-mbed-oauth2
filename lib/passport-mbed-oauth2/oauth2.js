...
function Strategy(options, verify) {
  ...
  options.tokenURL = options.tokenURL || options.authDomain + '/token/';
  console.log("the options are fine, see:");
  console.dir(options);
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(authDomain + '/userinfo/', accessToken, function (err, body, res) {
