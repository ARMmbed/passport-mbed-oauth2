...
function Strategy(options, verify) {
  ...
  options.mbedDomain = options.mbedDomain || mbedDomain;
  options.authorizationURL = options.authorizationURL || options.authDomain + '/authorize';
  options.tokenURL = options.tokenURL || options.authDomain + '/oauth/token';
  options.userInfoURL = options.userInfoURL || options.mbedDomain + '/api/v3/userinfo/';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  console.log(this.options.userInfoURL);
