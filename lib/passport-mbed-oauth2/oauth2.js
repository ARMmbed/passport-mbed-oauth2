...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || domain + '/o/authorize/';
  options.tokenURL = options.tokenURL || domain + '/o/token/';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get(domain + '/api/v3/userinfo/', accessToken, function (err, body, res) {
